/*
 * Interactive UI tool to practice Regular Expression
 * Originally developed as part of the Learning Regular Expression with .NET course.
 * https://www.udemy.com/learning-regular-expression-with-net
 */
using System;
